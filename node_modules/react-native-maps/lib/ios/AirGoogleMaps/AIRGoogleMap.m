...
- (void)didMoveToWindow {
  NSLog(@"didMoveToWindow start: initial[latd:%f lond:%f] region[latd:%f lond:%f]", _initialRegion.span.latitudeDelta, _initialRegion.span.longitudeDelta,  _region.span.latitudeDelta, _region.span.longitudeDelta);
  ...
  if (_initialRegion.span.latitudeDelta != 0.0 &&
    ...
    NSLog(@"didMoveToWindow initial deltas != 0: initial[latd:%f lond:%f] region[latd:%f lond:%f]", _initialRegion.span.latitudeDelta, _initialRegion.span.longitudeDelta,  _region.span.latitudeDelta, _region.span.longitudeDelta);
    ...
    NSLog(@"didMoveToWindow region deltas != 0: initial[latd:%f lond:%f] region[latd:%f lond:%f]", _initialRegion.span.latitudeDelta, _initialRegion.span.longitudeDelta,  _region.span.latitudeDelta, _region.span.longitudeDelta);
    self.camera = [AIRGoogleMap makeGMSCameraPositionFromMap:self andMKCoordinateRegion:_region];
  }
  NSLog(@"didMoveToWindow end: initial[latd:%f lond:%f] region[latd:%f lond:%f]", _initialRegion.span.latitudeDelta, _initialRegion.span.longitudeDelta,  _region.span.latitudeDelta, _region.span.longitudeDelta);
...
- (void)setRegion:(MKCoordinateRegion)region {
  NSLog(@"setRegion start: initial[latd:%f lond:%f] region[latd:%f lond:%f]", _initialRegion.span.latitudeDelta, _initialRegion.span.longitudeDelta,  _region.span.latitudeDelta, _region.span.longitudeDelta);
  ...
  NSLog(@"setRegion end: initial[latd:%f lond:%f] region[latd:%f lond:%f]", _initialRegion.span.latitudeDelta, _initialRegion.span.longitudeDelta,  _region.span.latitudeDelta, _region.span.longitudeDelta);
}

- (void)didPrepareMap {
  NSLog(@"didPrepareMap start");
  if (_didCallOnMapReady) return;
  _didCallOnMapReady = true;
  if (self.onMapReady) self.onMapReady(@{});
  NSLog(@"didPrepareMap end");
}
...
- (void)idleAtCameraPosition:(GMSCameraPosition *)position {
  NSLog(@"idleAtCameraPosition start");
  id event = @{@"continuous": @NO,
               @"region": regionAsJSON([AIRGoogleMap makeGMSCameraPositionFromMap:self andGMSCameraPosition:position]),
               };
  NSLog(@"idleAtCameraPosition event: %@", event);
  if (self.onChange) self.onChange(event);  // complete
  NSLog(@"idleAtCameraPosition end");
}
...
+ (MKCoordinateRegion) makeGMSCameraPositionFromMap:(GMSMapView *)map andGMSCameraPosition:(GMSCameraPosition *)position {
  NSLog(@"makeGMSCameraPositionFromMap:andGMSCameraPosition start");
  // solution from here: http://stackoverflow.com/a/16587735/1102215
  GMSVisibleRegion visibleRegion = map.projection.visibleRegion;
  NSLog(@"makeGMSCameraPositionFromMap:andGMSCameraPosition visible region far right: %f,%f", visibleRegion.farRight.latitude, visibleRegion.farRight.longitude);
  GMSCoordinateBounds *bounds = [[GMSCoordinateBounds alloc] initWithRegion: visibleRegion];
  NSLog(@"makeGMSCameraPositionFromMap:andGMSCameraPosition bounds north east: %f,%f", bounds.northEast.latitude, bounds.northEast.longitude);
  CLLocationCoordinate2D center;
  CLLocationDegrees longitudeDelta;
  CLLocationDegrees latitudeDelta = bounds.northEast.latitude - bounds.southWest.latitude;
  NSLog(@"makeGMSCameraPositionFromMap:andGMSCameraPosition latitude delta: %f", latitudeDelta);
  ...
  NSLog(@"makeGMSCameraPositionFromMap:andGMSCameraPosition span: %f,%f", span.latitudeDelta, span.longitudeDelta);
  NSLog(@"makeGMSCameraPositionFromMap:andGMSCameraPosition end");
...
+ (GMSCameraPosition*) makeGMSCameraPositionFromMap:(GMSMapView *)map andMKCoordinateRegion:(MKCoordinateRegion)region {
  ...
  CLLocationCoordinate2D b = CLLocationCoordinate2DMake(region.center.latitude - latitudeDelta,
                                                        region.center.longitude - longitudeDelta);
  NSLog(@"makeGMS... a %f,%f", a.latitude, a.longitude);
  NSLog(@"makeGMS... b %f,%f", b.latitude, b.longitude);
  NSLog(@"makeGMS... latd %f lond %f", b.latitude - a.latitude, b.longitude - a.longitude);
  GMSCoordinateBounds *bounds = [[GMSCoordinateBounds alloc] initWithCoordinate:a coordinate:b];
  NSLog(@"makeGMSCameraPosition calculated latd %f", bounds.northEast.latitude - bounds.southWest.latitude);
